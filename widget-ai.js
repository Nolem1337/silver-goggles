...
(function () {
  ...
  const CONFIG = {
    ...
    brandColor: "#0057a8",
    position: "right",
    apiKey: "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",
    ...
    function showChatScreen() {
      ...
      async function handleSend(text) {
        ...
        try {
          ...
          if (res.status === 401) { addMessage("Technická chyba autorizácie. Kontaktujte nás na +421 911 061 313.", "bot"); return; }
